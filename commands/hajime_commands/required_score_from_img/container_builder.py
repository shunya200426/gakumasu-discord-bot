...
def build_error_container(*, params: dict, score_dict: dict | None = None, bonus: dict | None = None, is_boost: bool = False) -> ui.Container:
    bonus = bonus or {}
    # 埋め込みカラーの設定
    color = 0xE67E22
    ...
    content = text_template.format(
        ...
        mid_exam_score  = _fmt_num(score_dict.get('sum_score'))
    )
